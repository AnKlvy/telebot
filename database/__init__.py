...
from .models import User, Course, Subject, Group, Student, Curator, Teacher, Manager, Microtopic, Lesson, Homework, Question, AnswerOption, MonthTest, MonthTestMicrotopic, BonusTest, BonusQuestion, BonusAnswerOption, HomeworkResult, QuestionResult, CourseEntryTestResult, CourseEntryQuestionResult, ShopItem, StudentPurchase, StudentBonusTest
from .repositories import UserRepository, CourseRepository, SubjectRepository, GroupRepository, StudentRepository, \
    ...
    HomeworkResultRepository, QuestionResultRepository, CourseEntryTestResultRepository, ShopItemRepository, StudentPurchaseRepository, StudentBonusTestRepository
