...
def register_handlers():
    ...
    manager_transitions = {**MANAGER_ANALYTICS_TRANSITIONS, **MANAGER_HOMEWORK_TRANSITIONS, **MANAGER_TOPICS_TRANSITIONS}
    manager_handlers = {**MANAGER_ANALYTICS_HANDLERS, **MANAGER_HOMEWORK_HANDLERS, **MANAGER_TOPICS_HANDLERS}
