...
def register_handlers():
    ...
    student_transitions = {**STUDENT_TRANSITIONS, **CURATOR_CONTACT_TRANSITIONS, **PROGRESS_TRANSITIONS, **SHOP_TRANSITIONS, **TEST_REPORT_TRANSITIONS, **ACCOUNT_TRANSITIONS, **TRIAL_ENT_TRANSITIONS, **QUIZ_TRANSITIONS}
    student_handlers = {**STUDENT_HANDLERS, **CURATOR_CONTACT_HANDLERS, **PROGRESS_HANDLERS, **SHOP_HANDLERS, **TEST_REPORT_HANDLERS, **ACCOUNT_HANDLERS, **TRIAL_ENT_HANDLERS, **QUIZ_HANDLERS}
